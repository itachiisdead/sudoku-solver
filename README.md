...
This repository contains a Python program that solves Sudoku puzzles.
...
3. Run the program:
4. Enter the Sudoku puzzle as a 9x9 grid, where empty cells are represented by zeros (0).
